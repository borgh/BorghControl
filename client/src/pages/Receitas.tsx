      ...
      <div className="grid grid-cols-3 gap-2">
        <Card className="bg-emerald-50 border-emerald-100">
          <CardContent className="p-3 text-center">
            ...
            <p className="text-sm sm:text-base font-bold text-emerald-700 tabular-nums">{fmt(total)}</p>
          </CardContent>
        </Card>
        <Card className="bg-emerald-50 border-emerald-100">
          <CardContent className="p-3 text-center">
            <p className="text-[10px] text-emerald-600 font-medium uppercase tracking-wide">Recebido</p>
            <p className="text-sm sm:text-base font-bold text-emerald-700 tabular-nums">{fmt(totalRecebido)}</p>
          </CardContent>
        </Card>
